...
from ...models.set_gateway_webhook_secret_body import SetGatewayWebhookSecretBody
from ...models.set_gateway_webhook_secret_provider import SetGatewayWebhookSecretProvider
from ...types import Response


def _get_kwargs(
    provider: SetGatewayWebhookSecretProvider,
    *,
    body: SetGatewayWebhookSecretBody,
) -> dict[str, Any]:
