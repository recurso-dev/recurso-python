...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Error | RequestPortalMagicLinkResponse200 | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[Error | RequestPortalMagicLinkResponse200]:
    return Response(
