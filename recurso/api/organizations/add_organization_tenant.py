...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> AddOrganizationTenantResponse200 | Error | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[AddOrganizationTenantResponse200 | Error]:
    return Response(
