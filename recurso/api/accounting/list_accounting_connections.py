...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Error | ListAccountingConnectionsResponse200 | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[Error | ListAccountingConnectionsResponse200]:
    return Response(
