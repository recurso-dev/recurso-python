...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/invoices/{id}/eu-einvoice".format(id=quote(str(id), safe=""),),
    }
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Error | GetEUEInvoiceResponse200 | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[Error | GetEUEInvoiceResponse200]:
    return Response(
