...
def sync_detailed(
    *,
    ...
    """Prometheus metrics
     ...
     Prometheus text-format metrics: HTTP request counts + latency histograms (by method/route/status)
    and Go runtime gauges. Optionally bearer-gated via the METRICS_TOKEN env; open when unset (scrape
