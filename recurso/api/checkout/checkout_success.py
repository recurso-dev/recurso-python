...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/checkout/{id}/success".format(id=quote(str(id), safe=""),),
        "params": params,
    }
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> CheckoutSuccessResponse200 | Error | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[CheckoutSuccessResponse200 | Error]:
    return Response(
