...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/checkout/{id}/razorpay/verify".format(id=quote(str(id), safe=""),),
    }
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> CheckoutRazorpayVerifyResponse200 | Error | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[CheckoutRazorpayVerifyResponse200 | Error]:
    return Response(
