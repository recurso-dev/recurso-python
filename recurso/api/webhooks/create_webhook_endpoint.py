...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> CreateWebhookEndpointResponse201 | Error | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[CreateWebhookEndpointResponse201 | Error]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        CreateWebhookEndpointResponse201 | Error
     """
