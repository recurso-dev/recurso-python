...
from ...models.upsert_sso_connection_response_200 import UpsertSSOConnectionResponse200
...
) -> Error | UpsertSSOConnectionResponse200 | None:
    if response.status_code == 200:
        response_200 = UpsertSSOConnectionResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | UpsertSSOConnectionResponse200]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Error | UpsertSSOConnectionResponse200
    """
