...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Error | GetInvoiceAgingResponse200 | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[Error | GetInvoiceAgingResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    61-90 / 90+), normalized to the reporting currency. Optional entity_id scopes to one legal entity;
    omitted = all entities.
