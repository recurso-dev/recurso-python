...
T = TypeVar("T", bound="GetCustomerFinancialSummaryResponse200DataCurrenciesItem")


@_attrs_define
class GetCustomerFinancialSummaryResponse200DataCurrenciesItem:
    """
    Attributes:
        currency (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_customer_financial_summary_response_200_data_currencies_item = cls(
            currency=currency,
        ...
        get_customer_financial_summary_response_200_data_currencies_item.additional_properties = d
        return get_customer_financial_summary_response_200_data_currencies_item
