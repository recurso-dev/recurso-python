...
T = TypeVar("T", bound="PostV1IntegrationConnectionsResponse201")



@_attrs_define
class PostV1IntegrationConnectionsResponse201:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_v1_integration_connections_response_201 = cls(
            data=data,
        )


        post_v1_integration_connections_response_201.additional_properties = d
        return post_v1_integration_connections_response_201
