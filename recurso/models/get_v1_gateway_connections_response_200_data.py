...
T = TypeVar("T", bound="GetV1GatewayConnectionsResponse200Data")


@_attrs_define
class GetV1GatewayConnectionsResponse200Data:
    """
    Attributes:
        connections (list[GatewayConnectionView] | Unset):
        vault_ready (bool | Unset):
    """

    connections: list[GatewayConnectionView] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _connections is not UNSET:
            ...
            for connections_item_data in _connections:
                connections_item = GatewayConnectionView.from_dict(connections_item_data)

                connections.append(connections_item)

        vault_ready = d.pop("vault_ready", UNSET)

        get_v1_gateway_connections_response_200_data = cls(
            connections=connections,
            vault_ready=vault_ready,
        )

        get_v1_gateway_connections_response_200_data.additional_properties = d
        return get_v1_gateway_connections_response_200_data
