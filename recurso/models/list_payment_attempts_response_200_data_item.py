...
from ..models.list_payment_attempts_response_200_data_item_status import ListPaymentAttemptsResponse200DataItemStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListPaymentAttemptsResponse200DataItem")


@_attrs_define
class ListPaymentAttemptsResponse200DataItem:
    """
    Attributes:
        id (UUID | Unset):
        ...
        status (ListPaymentAttemptsResponse200DataItemStatus | Unset):
    ...
    status: ListPaymentAttemptsResponse200DataItemStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_status, Unset):
            ...
            status = ListPaymentAttemptsResponse200DataItemStatus(_status)
        ...
        list_payment_attempts_response_200_data_item = cls(
            id=id,
        ...
        list_payment_attempts_response_200_data_item.additional_properties = d
        return list_payment_attempts_response_200_data_item
