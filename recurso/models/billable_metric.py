...
class BillableMetric:
    ...
    tenant.
        ...
        Attributes:
            ...
            expression (str | Unset): Sandboxed per-event formula for the `custom` aggregation (e.g. `quantity *
                properties.multiplier`); its results are summed over the period. Empty for every other aggregation.
