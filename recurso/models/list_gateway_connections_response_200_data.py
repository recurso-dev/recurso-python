...
T = TypeVar("T", bound="ListGatewayConnectionsResponse200Data")


@_attrs_define
class ListGatewayConnectionsResponse200Data:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_gateway_connections_response_200_data = cls(
            connections=connections,
            vault_ready=vault_ready,
        )

        list_gateway_connections_response_200_data.additional_properties = d
        return list_gateway_connections_response_200_data
