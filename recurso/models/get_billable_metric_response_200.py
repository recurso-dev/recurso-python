...
T = TypeVar("T", bound="GetBillableMetricResponse200")


@_attrs_define
class GetBillableMetricResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_billable_metric_response_200 = cls(
            data=data,
        )

        get_billable_metric_response_200.additional_properties = d
        return get_billable_metric_response_200
