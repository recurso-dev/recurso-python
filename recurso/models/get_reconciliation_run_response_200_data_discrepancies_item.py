...
T = TypeVar("T", bound="GetReconciliationRunResponse200DataDiscrepanciesItem")


@_attrs_define
class GetReconciliationRunResponse200DataDiscrepanciesItem:
    """
    Attributes:
        type_ (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        account_code = d.pop("account_code", UNSET)

        expected_amount = d.pop("expected_amount", UNSET)

        found_amount = d.pop("found_amount", UNSET)

        get_reconciliation_run_response_200_data_discrepancies_item = cls(
            type_=type_,
        ...
        get_reconciliation_run_response_200_data_discrepancies_item.additional_properties = d
        return get_reconciliation_run_response_200_data_discrepancies_item
