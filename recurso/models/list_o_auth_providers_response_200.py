...
T = TypeVar("T", bound="ListOAuthProvidersResponse200")


@_attrs_define
class ListOAuthProvidersResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_o_auth_providers_response_200 = cls(
            providers=providers,
        )

        list_o_auth_providers_response_200.additional_properties = d
        return list_o_auth_providers_response_200
