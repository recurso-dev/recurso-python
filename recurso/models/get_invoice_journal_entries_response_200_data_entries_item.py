...
T = TypeVar("T", bound="GetInvoiceJournalEntriesResponse200DataEntriesItem")


@_attrs_define
class GetInvoiceJournalEntriesResponse200DataEntriesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_invoice_journal_entries_response_200_data_entries_item = cls(
        ...
        get_invoice_journal_entries_response_200_data_entries_item.additional_properties = d
        return get_invoice_journal_entries_response_200_data_entries_item
