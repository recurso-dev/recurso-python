...
T = TypeVar("T", bound="ListIntegrationConnectionsResponse200Data")


@_attrs_define
class ListIntegrationConnectionsResponse200Data:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_integration_connections_response_200_data = cls(
            connections=connections,
            vault_ready=vault_ready,
        )

        list_integration_connections_response_200_data.additional_properties = d
        return list_integration_connections_response_200_data
