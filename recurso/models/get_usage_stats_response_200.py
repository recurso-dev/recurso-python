...
T = TypeVar("T", bound="GetUsageStatsResponse200")


@_attrs_define
class GetUsageStatsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = UsageStats.from_dict(data_item_data)
        ...
        return get_usage_stats_response_200
