...
T = TypeVar("T", bound="UpdateBillableMetricResponse200")


@_attrs_define
class UpdateBillableMetricResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_billable_metric_response_200 = cls(
            data=data,
        )

        update_billable_metric_response_200.additional_properties = d
        return update_billable_metric_response_200
