...
T = TypeVar("T", bound="CreateEntityResponse201")



@_attrs_define
class CreateEntityResponse201:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_entity_response_201 = cls(
            data=data,
        )


        create_entity_response_201.additional_properties = d
        return create_entity_response_201
