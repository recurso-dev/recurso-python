...
if TYPE_CHECKING:
  ...
  from ..models.get_dunning_recovered_response_200_recovered_amount_total import GetDunningRecoveredResponse200RecoveredAmountTotal
...
class GetDunningRecoveredResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_recovered_amount_total,  Unset):
            ...
            recovered_amount_total = GetDunningRecoveredResponse200RecoveredAmountTotal.from_dict(_recovered_amount_total)
