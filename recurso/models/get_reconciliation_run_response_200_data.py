...
if TYPE_CHECKING:
    from ..models.get_reconciliation_run_response_200_data_discrepancies_item import (
        GetReconciliationRunResponse200DataDiscrepanciesItem,
    )


T = TypeVar("T", bound="GetReconciliationRunResponse200Data")


@_attrs_define
class GetReconciliationRunResponse200Data:
    """
    Attributes:
        id (UUID | Unset):
        ...
        discrepancies_truncated (bool | Unset):
        discrepancies (list[GetReconciliationRunResponse200DataDiscrepanciesItem] | Unset):
    """
    ...
    discrepancies_truncated: bool | Unset = UNSET
    discrepancies: list[GetReconciliationRunResponse200DataDiscrepanciesItem] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        discrepancies_truncated = self.discrepancies_truncated
        ...
        if discrepancies_truncated is not UNSET:
            field_dict["discrepancies_truncated"] = discrepancies_truncated
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        discrepancies_truncated = d.pop("discrepancies_truncated", UNSET)
        ...
        if _discrepancies is not UNSET:
            ...
            for discrepancies_item_data in _discrepancies:
                discrepancies_item = GetReconciliationRunResponse200DataDiscrepanciesItem.from_dict(
                    discrepancies_item_data
                )

                discrepancies.append(discrepancies_item)

        get_reconciliation_run_response_200_data = cls(
            id=id,
            run_by=run_by,
            run_at=run_at,
            ...
            discrepancies_truncated=discrepancies_truncated,
            discrepancies=discrepancies,
        )

        get_reconciliation_run_response_200_data.additional_properties = d
        return get_reconciliation_run_response_200_data
